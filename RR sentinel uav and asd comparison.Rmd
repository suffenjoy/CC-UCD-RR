...
#plot average
par(mfrow = c(1,1))
plot(x = wavelen_uav, y = plot_uav_43[2:6], type = "o", col = "green", xlab = "wavelength", ylab = "reflectance", main = "Plot 4-3", pch = 20, ylim = c(0,0.40))
...
#plot average
par(mfrow = c(1,1))
plot(x = wavelen_uav, y = plot_uav_52[2:6], type = "o", col = "green", xlab = "wavelength", ylab = "reflectance", main = "Plot 5-2", pch = 20, ylim = c(0,0.40))
...
```{r}
par(mfrow = c(1,1))
plot(x = ave_asd43$wavelength, y = ave_asd43$reflecntace, type = 'l', col = "orange", xlab = "wavelength", ylab = "reflectance", main = "Plot 4-3", ylim = c(0,1.0))
