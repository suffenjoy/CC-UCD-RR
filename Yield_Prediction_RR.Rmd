...
##Harvest Index
```{r}
ggplot(tomall9417_cl, aes(x = greenDM, y = yield, col = system_code)) + geom_point() + geom_smooth(method = lm, se = FALSE) + xlim(c(0,5000))


cor(tomall9417_cl_plotagg$yield, tomall9417_cl_plotagg$vineDM)
```
