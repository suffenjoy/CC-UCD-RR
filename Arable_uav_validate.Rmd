...
names(classsum_20190530)[1:2] <- c("veg","soil")
...
sapply(ls_classsum, function(x){x$total = apply(x[,sapply(x, is.numeric)])})
...
#add dates 
ccclass5_20190523$date <- as.Date("2019-05-23")
ccclass5_20190530$date <- as.Date("2019-05-30")
ccclass5_20190614$date <- as.Date("2019-06-14")
ccclass5_20190620$date <- as.Date("2019-06-20")
ccclass5_20190626$date <- as.Date("2019-06-26")
ccclass5_20190703$date <- as.Date("2019-07-03")
ccclass5_20190718$date <- as.Date("2019-07-18")
#ccfield_20190725$date <- as.Date("2019-07-25")
ccclass5_20190801$date <- as.Date("2019-08-01")
ccclass5_20190808$date <- as.Date("2019-08-14")
ccclass5_20190814$date <- as.Date("2019-08-14")
ccclass5_20190822$date <- as.Date("2019-08-22")

ccclass5_uav <- rbind(ccclass5_20190523, ccclass5_20190530,ccclass5_20190614,ccclass5_20190620, ccclass5_20190626, ccclass5_20190703, ccclass5_20190718,  ccclass5_20190801, ccclass5_20190808, ccclass5_20190814, ccclass5_20190822)

```
###plot the canopy cover change
```{r}
ggplot(ccclass5_uav, aes(x = date, y = cc, color = Field)) + geom_point() + geom_line() + ylab("Canopy Cover") + ggtitle("Canopy Cover Change") + xlab("Date") + scale_x_date(date_labels = "%m/%d", date_breaks = "2 weeks")
